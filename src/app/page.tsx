      ...
      <div className="max-w-6xl mx-auto px-8 md:px-16 pb-12 -mt-56">
        ...
        <section className="mb-16">
          ...
          <div className="mt-8 pt-8 border-t border-stone-200">
            <h3 className="text-xl font-bold text-stone-800 mb-4 font-heading">
              Get in Touch
            </h3>
            <p className="text-stone-600 mb-5">
              Have questions or ready to book? Reach out directly &mdash; I&apos;m happy to help.
            </p>
            <div className="flex flex-wrap gap-3">
              <a
                href="https://wa.me/15125176805"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#25D366] text-white text-sm font-medium hover:bg-[#1ebe57] transition-colors shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white text-sm font-medium hover:opacity-90 transition-opacity shadow-sm"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-stone-700 text-white text-sm font-medium hover:bg-stone-800 transition-colors shadow-sm"
              >
